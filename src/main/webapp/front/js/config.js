...
var centerMenu = [
    ...
    ,{
        name: '景点收藏',
        url: '../jingdianCollection/list.html'
    }
    ,{
        name: '旅游景点预定',
        url: '../jingdianOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/xianlvyouguanli/admin/dist/index.html#/login";
