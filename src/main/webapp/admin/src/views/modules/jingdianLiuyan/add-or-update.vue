    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="jingdianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.jingdianLiuyanText" v-model="ruleForm.jingdianLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jingdianLiuyanText" label="留言内容" prop="jingdianLiuyanText">
                            <span v-html="ruleForm.jingdianLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.jingdianId = true;//景点
                this.ro.yonghuId = true;//用户
                this.ro.jingdianLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jingdianLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jingdianLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
