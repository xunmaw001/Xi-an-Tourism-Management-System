    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jingdianId" name="jingdianId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预定时间" prop="jingdianOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jingdianOrderTime"
                                type="datetime"
                                placeholder="预定时间"
                                :disabled="ro.jingdianOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jingdianOrderTime" label="预定时间" prop="jingdianOrderTime">
                            <span v-html="ruleForm.jingdianOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预定人数" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="预定人数" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预定人数" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="预定人数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jingdianId: [
                              { required: true, message: '旅游景点不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   buyNumber: [
                              { required: true, message: '预定人数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jingdianOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jingdianOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
